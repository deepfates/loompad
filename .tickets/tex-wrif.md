...
2026-08-02 exact browser correction on current main: the ordinary visible multi-file picker does admit the Behold manifest plus both canonical resident files, but the first episode-000012 attempt failed because WebKit supplied a 1,114,112-byte native Blob chunk to Lync's explicitly 1,048,576-byte indexed admission boundary. The browser File adapter now splits arbitrary native chunks into at-most-1-MiB pieces without changing, copying, or weakening the authenticated prefix. A focused regression supplies the observed oversized shape. The repaired visible local-only reader then opened exact episode 000014: 56,638,047 authenticated bytes, 692 source events, 690 readable turns, two structural roots, all presented, zero nonconforming events. Navigating the real Lark life exposed the 1h23m wall-clock gap after turn 228 rather than presenting stop/resume as one scene. Full verify is 227 pass / one opt-in scale skip plus lint and production builds. This crosses the browser front-door defect and current 56 MB checkpoint; the ticket remains open for its stated representative retained six-hour-scale browser exercise rather than promoting the existing synthetic projector gate.

**2026-08-02T11:17:02Z**

2026-08-02 pinned Lync candidate 0a511b6 adds truthful place_held_against_focus presentation. The exact episode-000019 ordered-prefix front door imported 68,444,160 authenticated bytes: 871 source events, 869 readable, two structural, zero unsupported diagnostics, 12,278 explicit source-only/withheld diagnostics. Full Textile verify passes (228 pass, one opt-in scale skip, lint, production builds). This repairs presentation completeness but does not close the ticket's retained six-hour browser exercise.
