...
- `presenters/behold-inhabitant.js` SHA-256 `ec0127caaf06ce5fa6880fffea724d8f2469fbe48e708d1d2933471c4f217aa9`
...
shapes and the current world-event wait result; all other unknown shapes still
fail closed. `index.d.ts` keeps Textile's published-0.3-compatible
